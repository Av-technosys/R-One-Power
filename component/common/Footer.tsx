...
const services = [
  {
    ...
    href: "/services?tab=pm-surya-ghar",
  },
  {
    name: "Commercial Solar",
    href: "/services?tab=commercial-industrial",
  },
  {
    name: "Industrial Solar",
    href: "/services?tab=pm-kusum",
  },
  {
    name: "Battery Storage",
    href: "/services?tab=hybrid-off-grid",
  },
  {
    name: "Solar AMC",
    href: "/services?tab=open-access-resco",
  },
  {
    name: "Net Metering",
    href: "/services?tab=om-consultancy",
  },
]
...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#111827] via-[#1F2937] to-[#111827] text-gray-400 font-inter pt-10">
      <div className="max-w-7xl mx-auto md:px-10 px-4 pb-4">
