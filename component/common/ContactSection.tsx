    ...
    <section className="py-24 bg-white font-inter">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <h3 className="text-2xl font-black text-slate-900 mb-8 font-poppins">Request Callback</h3>
            
            <form className="space-y-5">
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 ml-1">Your Name *</label>
                <Input placeholder="Enter your full name" className="h-12 bg-slate-50 border-gray-100 rounded-xl focus-visible:ring-[#1E88E5]" />
              </div>

              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 ml-1">Email Address *</label>
                <Input type="email" placeholder="Enter your email" className="h-12 bg-slate-50 border-gray-100 rounded-xl focus-visible:ring-[#1E88E5]" />
              </div>

              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 ml-1">Phone Number *</label>
                <Input placeholder="Enter your phone number" className="h-12 bg-slate-50 border-gray-100 rounded-xl focus-visible:ring-[#1E88E5]" />
              </div>

              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 ml-1">City *</label>
                <Input placeholder="e.g., Jaipur" className="h-12 bg-slate-50 border-gray-100 rounded-xl focus-visible:ring-[#1E88E5]" />
              </div>

              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 ml-1">Your Requirement</label>
                <Textarea placeholder="Tell us about your solar requirements..." className="min-h-[120px] bg-slate-50 border-gray-100 rounded-xl focus-visible:ring-[#1E88E5] resize-none" />
              </div>

              <Button className="w-full h-14 bg-[#1E88E5] hover:bg-[#1565C0] text-white font-bold rounded-xl text-md flex items-center gap-2 shadow-lg shadow-blue-100 mt-4 transition-all">
                <IconSend size={18} /> Request Callback
              </Button>
          ...
          <div className="space-y-8">
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
              <span className="text-[#FB8C00] font-bold text-xs uppercase tracking-widest mb-2 block">Find Us</span>
              <h3 className="text-3xl font-black text-slate-900 mb-6 font-poppins">Our Location</h3>
              ...
              <div className="relative rounded-3xl overflow-hidden border border-gray-100 shadow-xl h-[450px] group">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 border border-gray-100">
                  <span className="text-[12px] font-bold text-slate-800">Open in Maps</span>
            ...
            >
              <h4 className="text-lg font-black text-slate-900 mb-2 font-poppins">Quick Call</h4>
